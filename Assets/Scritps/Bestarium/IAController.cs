...
public class IAController : MonoBehaviour
{
    ...
    [Range(0,1)] private int _attackPosition = 0;
    ...
    public int GetAttackPosition { get { return _attackPosition; } }
    ...
    public int SetAttackPosition { set { _attackPosition = value; } }
    ...
    private void SetBattleStates()
    {
        ...
        _battleStates.Add(E_BattleState.RESULTTURN, new ResultTurnState());
        ...
        _battleStates[E_BattleState.RESULTTURN].Init(this);
